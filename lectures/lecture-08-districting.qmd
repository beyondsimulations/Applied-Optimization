...
- [Contiguity]{.highlight}: No isolated areas
- [Compactness]{.highlight}: Round shape
...
::: {.incremental}
- Geographic areas → [Centroids]{.highlight} (center points)
...
::: {.callout-tip}
This abstraction allows us to use [powerful optimization techniques]{.highlight} from graph theory and location science!
:::
...
::: {.callout-important}
Note: Department locations are a [subset]{.highlight} of all BAs - not every BA can host a department!
:::
:::
:::
...
[Question:]{.question} **How does this relate to facility location problems?**
