...
# # Recap
#
# To structure the discussion (and your exam preparation), here is a
# compact overview of the problems we have modeled and the key modeling
# idea each one introduced:
#
...
#
# For the Julia and JuMP syntax, take a look at the [Julia
# cheatsheet](../general/cheatsheet-julia.qmd) and the [JuMP
# cheatsheet](../general/cheatsheet-jump.qmd).
#
...
# - Why do subtours appear in the routing model, and how did we prevent
#   them?
# - Which models were solvable exactly, and where did we need heuristics?
# - If you had to simplify a real-world problem into a model, which
#   assumptions would you question first?
#
# > **Note**
# >
# > Exam logistics in short: you can bring **one DIN A4 sheet** with notes
# > on both sides, and your bonus points count if your mark is at least
# > 4.0. See the [FAQ](../general/faq.qmd) for the details.
#
...
# absolutely no influence on your grade! The half point counts toward your
# exam bonus points, just like the tutorial submissions. In total I think
# it will take you about 15–20 minutes to complete the form - that’s not
# too bad given that you will receive half a bonus point for it, right?
#
# In all honesty, I know this is a lot to ask of you - especially given
# that the exams are coming up. However, I think it is very important for
# me to get your honest opinion and feedback. I will use it to improve the
# course for future students, as well as for my future teaching.
...
# <https://tally.so/r/Ekl9gN>. Note that the form is provided by
# [Tally](https://tally.so), a third-party service that processes your
# responses.
#
# # Wrap-up
#
# Thanks for your participation! I wish you all the best for your exam and
# I hope you enjoyed the course! If you have any questions, please feel
# free to ask me or send me an email. We offer seminars each summer
