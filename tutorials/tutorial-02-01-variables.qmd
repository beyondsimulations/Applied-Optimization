...
8. If you work with `.jl` files, right-click on any dowloaded `.jl` file and select "Open with Jupyter Notebook". If you work with `.ipynb` files, just open the file and you are good to go.
