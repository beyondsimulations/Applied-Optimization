...
8. Download the first `.ipynb` notebook from the course website and save it in your course folder. You can do so by clicking on Jupyter on the course website.
