...
Julia allows you to specify types explicitly, which can improve performance and catch errors early. For example, to assign an Float64 to a variable, you can do the following:
...
String interpolation allows you to embed expressions into string literals. In Julia, this is done using the `$` symbol. If you have paid attention to the previous excercise, you have already seen this in action. The following example illustrates this again:
