...
::: {.callout-tip}
## Use the SCIP solver
If you don't have SCIP or JuMP installed, add the solver via Pkg.add("SCIP") and Pkg.add("JuMP").
:::
...
@assert termination_status(warehouse_model) == MOI.OPTIMAL "The model should be solved with an optimal solution"
@assert objective_value(warehouse_model) == 141 "The objective value should be 141. Have you correctly implemented the objective function?"
