...
# %% [markdown]
# # Tutorial III.V - Plotting Graphs
#
...
custom_line_plot = plot(
    ...
    marker=(:star, 3)  # Circle markers of size 8
)
...
y2 = rand(30)
y3 = rand(30)
multi_series_plot = plot(
    x, y1, label="Series A"
)
plot!(multi_series_plot, x, y2, label="Series B")
plot!(multi_series_plot, x, y3, label="Series C")
...
savefig(multi_series_plot, "$(@__DIR__)/ExampleData/saved_plot.png")
