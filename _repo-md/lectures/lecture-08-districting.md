...
> **Tip**
>
> This abstraction allows us to use <span class="highlight">optimization techniques</span> from graph theory and location science!
...
> **Important**
>
> Department locations are a <span class="highlight">subset</span> of all BAs as not every BA can host a department!
...
<span class="question">Question:</span> **How does this relate to these problems?**
...
<span class="highlight">Goal:</span> Redesign districts to improve response time.
...
<span class="highlight">Goal:</span> Optimize coverage with limited resources.
...
<span class="invert-font">**How did we validate the results?**</span>
