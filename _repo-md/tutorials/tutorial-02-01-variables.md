...
7.  Download the first `.ipynb` notebook from the course website and save it in your course folder. You can do so by clicking on Jupyter on the course website.

8.  Now, just open the`.ipynb` file and you are good to go.

9.  Click the kernel selector (top-right corner) and choose "Applied Optimization" from the list.
